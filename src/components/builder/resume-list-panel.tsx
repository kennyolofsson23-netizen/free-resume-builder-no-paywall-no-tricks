    ...
    <div className="flex flex-col gap-3 p-4">
      ...
      {resumeList.length === 0 ? (
        <p className="text-xs text-muted-foreground">
          No other resumes saved yet. Each resume you create is stored locally
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              This permanently removes the resume from your browser.
              There&apos;s no undo — export it as JSON first if you want a
              backup.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Your current resume stays saved in the list below — you can switch
              back to it anytime. A fresh blank resume will open.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
