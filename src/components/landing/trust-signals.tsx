      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <div className="rounded-lg border border-border bg-card p-6">
            ...
            <div className="rounded-md bg-green-50 p-3 text-sm text-green-700 dark:bg-green-950 dark:text-green-300">
              <span className="font-semibold">Us:</span> PDF download is
              completely free
            </div>
          </div>
          ...
          <div className="rounded-lg border border-border bg-card p-6">
            ...
            <div className="rounded-md bg-green-50 p-3 text-sm text-green-700 dark:bg-green-950 dark:text-green-300">
              <span className="font-semibold">Us:</span> No account, no email
              needed
            </div>
          </div>
        ...
        <div className="mt-12 rounded-lg border border-border bg-muted/50 p-8 text-center">
          <p className="text-lg font-bold text-foreground">
            We believe your resume data belongs to you — not us. Zero data
            collection. Zero tracking. Zero paywall.
          </p>
        </div>
      </div>
    </section>
