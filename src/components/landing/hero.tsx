      ...
      <div className="mx-auto max-w-4xl">
        <div className="text-center">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
            <Link href="/builder" className="inline-flex items-center justify-center rounded-lg bg-white px-8 py-3 font-semibold text-slate-900 transition-colors hover:bg-slate-100">
              Build Your Resume — It&apos;s Free →
            </Link>
            <Link href="/templates" className="inline-flex items-center justify-center rounded-lg border border-white px-8 py-3 font-semibold text-white transition-colors hover:bg-white/10">
              View Templates
            </Link>
          </div>
