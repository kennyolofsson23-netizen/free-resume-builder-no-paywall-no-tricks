...
_(Identical test matrix applies to Education, Skills, Projects, and Certifications — all must be covered in the actual test file.)_
...
export class BuilderPage {
  ...
  goto() {
    return this.page.goto('/builder')
  }
  formPanel() {
    return this.page.getByTestId('form-panel')
  }
  previewPanel() {
    return this.page.getByTestId('preview-panel')
  }
  previewContainer() {
    return this.page.locator('#resume-preview-container')
  }
  fullNameInput() {
  ...
  downloadBtn() {
    return this.page.getByTestId('download-pdf-btn')
  }
  shareBtn() {
    return this.page.getByTestId('share-btn')
  }
  templateSelector() {
    return this.page.getByTestId('template-selector')
  }
  undoBtn() {
  ...
  newResumeBtn() {
    return this.page.getByTestId('new-resume-btn')
  }
  mobilePreviewBtn() {
    return this.page.getByTestId('mobile-preview-btn')
  }
  exportJsonBtn() {
...
export class LandingPage {
  ...
  headline() {
    return this.page.getByTestId('hero-headline')
  }
  ctaButton() {
...
export class SharedPreviewPage {
  constructor(private page: Page) {}
  gotoWithHash(hash: string) {
    return this.page.goto(`/preview#${hash}`)
  }
  previewContainer() {
    return this.page.locator('#resume-preview-container')
  }
  ctaBanner() {
    return this.page.getByTestId('preview-cta')
  }
  formPanel() {
    return this.page.getByTestId('form-panel')
  }
...
it('resumeSchema: any structurally valid resume passes', () => {
  fc.assert(
    fc.property(validResumeArb, (data) => {
...
it('pastStates.length never exceeds MAX_UNDO_HISTORY regardless of update count', () => {
  fc.assert(
    fc.property(fc.integer({ min: 1, max: 200 }), (numChanges) => {
      const store = useResumeStore.getState()
      store.createNewResume()
...
export const fullResume = {
  ...
  personalInfo: {
    ...
    summary:
      'Senior full-stack engineer with 10+ years of experience building scalable web applications.',
  },
  experiences: [
    {
      id: 'exp-1',
      ...
      description:
        'Led platform modernization initiative. Reduced p99 latency by 40%.',
    },
    {
      id: 'exp-2',
  ...
  projects: [
    {
      id: 'proj-1',
      title: 'Open Resume Fork',
      description: 'Extended open-source resume builder.',
      link: 'https://github.com/alex/resume',
